 ...
 */
export const convertStringToNumber = (payload) => {
  const convertedNumber = payload.replace(/,/g, "");
 ...
 */
export function isError(error, status?) {
 ...
 */
export const hasAttributeWithValue = (jsonObj, prop) => {
  return (
